...
export class ProductController {
  ...
  @Auth(endpoint.create)
  @Patch(':productId')
  async update(@Param() params: ProductParamDto, @Body() updateProductDto: UpdateProductDto,@User() user:UserDocument,):Promise<IResponse<ProductResponse>> {
  ...
  async updateAttachment(
   ...
   async addToWishList(@Param() params:ProductParamDto,@User() user:UserDocument):Promise<IResponse<ProductResponse>> {
   ...
   async removeFromWishList(@Param() params:ProductParamDto,@User() user:UserDocument):Promise<IResponse> {
