...
export const cloudFileUpload=({storageApproach=StorageEnum.memory,validation=[],fileSize=2}:{storageApproach?:StorageEnum,folder?:string,validation:string[],fileSize?:number}):MulterOptions=>{
